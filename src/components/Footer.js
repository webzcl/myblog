  ...
  render () {
    return(
      <footer>
        ...
        <Link to='/work' activeStyle={{color:'#fff'}}><i className="fa fa-home" aria-hidden="true"></i><br />Home</Link>
        <Link to='/about' activeStyle={{color:'#fff'}}><i className="fa fa-home" aria-hidden="true"></i><br />Home</Link>
      </footer>
    )
  }
}
